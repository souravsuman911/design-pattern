# Ecommerce Recommendations LLD

Implementation: `EcommerceRecommendationsClient.java`

## Category
Feed and Timeline Systems

## Scope
Interview-ready low-level design for **Ecommerce Recommendations**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
