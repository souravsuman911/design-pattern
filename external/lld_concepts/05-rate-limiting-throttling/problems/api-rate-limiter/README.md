...
Implementation: `ApiRateLimiterClient.java`

## Category
Rate Limiting and Throttling

## Scope
Interview-ready low-level design for **Api Rate Limiter**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
