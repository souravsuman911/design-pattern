# Otp Request Limiter LLD

Implementation: `OtpRequestLimiterClient.java`

## Category
Rate Limiting and Throttling

## Scope
Interview-ready low-level design for **Otp Request Limiter**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
