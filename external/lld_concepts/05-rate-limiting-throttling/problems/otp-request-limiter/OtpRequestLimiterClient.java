...
public class OtpRequestLimiterClient{public static void main(String[]args){RateLimiter limiter=new RateLimiter();System.out.println(limiter.allow("client"));System.out.println(limiter.allow("client"));System.out.println(limiter.allow("client"));}}
