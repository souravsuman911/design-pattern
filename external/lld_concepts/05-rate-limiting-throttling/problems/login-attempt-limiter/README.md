# Login Attempt Limiter LLD

Implementation: `LoginAttemptLimiterClient.java`

## Category
Rate Limiting and Throttling

## Scope
Interview-ready low-level design for **Login Attempt Limiter**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
