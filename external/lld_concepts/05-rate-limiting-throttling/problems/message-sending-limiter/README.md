# Message Sending Limiter LLD

Implementation: `MessageSendingLimiterClient.java`

## Category
Rate Limiting and Throttling

## Scope
Interview-ready low-level design for **Message Sending Limiter**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
