...
Implementation: `RoleBasedAccessControlClient.java`

## Category
Access Control and Authorization

## Scope
Interview-ready low-level design for **Role Based Access Control**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
