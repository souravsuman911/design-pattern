...
public class VendingMachineClient{public static void main(String[]args){LldService service=new LldService();service.add(new DomainEntity("Vending Machine"));DomainEntity entity=service.assign();service.complete(entity.id);System.out.println(entity.name+" -> "+entity.status);}}
