...
Implementation: `InventoryManagementSystemClient.java`

## Category
Inventory and Order Management

## Scope
Interview-ready low-level design for **Inventory Management System**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
