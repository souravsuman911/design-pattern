...
Implementation: `ParkingLotClient.java`

## Category
Resource Allocation and Reservation

## Scope
Interview-ready low-level design for **Parking Lot**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
