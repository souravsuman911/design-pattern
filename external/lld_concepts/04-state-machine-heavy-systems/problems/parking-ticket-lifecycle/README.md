# Parking Ticket Lifecycle LLD

Implementation: `ParkingTicketLifecycleClient.java`

## Category
State Machine Heavy Systems

## Scope
Interview-ready low-level design for **Parking Ticket Lifecycle**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
