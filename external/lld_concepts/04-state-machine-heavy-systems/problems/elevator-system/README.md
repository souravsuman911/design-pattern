...
Implementation: `ElevatorSystemClient.java`

## Category
State Machine Heavy Systems

## Scope
Interview-ready low-level design for **Elevator System**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
