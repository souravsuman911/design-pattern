# News Feed Subscription LLD

Implementation: `NewsFeedSubscriptionClient.java`

## Category
Notification and Pub-Sub Systems

## Scope
Interview-ready low-level design for **News Feed Subscription**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
