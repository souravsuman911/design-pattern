# Stock Price Alert LLD

Implementation: `StockPriceAlertClient.java`

## Category
Notification and Pub-Sub Systems

## Scope
Interview-ready low-level design for **Stock Price Alert**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
