...
public class NotificationSystemClient{public static void main(String[]args){LldService service=new LldService();service.add(new DomainEntity("Notification System"));DomainEntity entity=service.assign();service.complete(entity.id);System.out.println(entity.name+" -> "+entity.status);}}
