...
Implementation: `PubSubSystemClient.java`

## Category
Notification and Pub-Sub Systems

## Scope
Interview-ready low-level design for **Pub Sub System**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
