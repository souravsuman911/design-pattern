...
Implementation: `DropboxClient.java`

## Category
File Storage and Hierarchical Systems

## Scope
Interview-ready low-level design for **Dropbox**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
