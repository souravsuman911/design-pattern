# Organization Hierarchy LLD

Implementation: `OrganizationHierarchyClient.java`

## Category
File Storage and Hierarchical Systems

## Scope
Interview-ready low-level design for **Organization Hierarchy**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
