...
Implementation: `InMemoryFileSystemClient.java`

## Category
File Storage and Hierarchical Systems

## Scope
Interview-ready low-level design for **In Memory File System**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
