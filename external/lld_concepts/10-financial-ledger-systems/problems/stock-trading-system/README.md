# Stock Trading System LLD

Implementation: `StockTradingSystemClient.java`

## Category
Financial and Ledger Systems

## Scope
Interview-ready low-level design for **Stock Trading System**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
