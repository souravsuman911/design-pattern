...
Implementation: `ExpenseTrackerClient.java`

## Category
Financial and Ledger Systems

## Scope
Interview-ready low-level design for **Expense Tracker**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
