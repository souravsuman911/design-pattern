...
Implementation: `RideSharingClient.java`

## Category
Matching and Assignment Systems

## Scope
Interview-ready low-level design for **Ride Sharing**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
