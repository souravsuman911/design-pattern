# Customer Support Ticket Assignment LLD

Implementation: `CustomerSupportTicketAssignmentClient.java`

## Category
Matching and Assignment Systems

## Scope
Interview-ready low-level design for **Customer Support Ticket Assignment**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
