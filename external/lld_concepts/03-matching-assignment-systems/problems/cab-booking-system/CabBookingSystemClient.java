...
public class CabBookingSystemClient{public static void main(String[]args){LldService service=new LldService();service.add(new DomainEntity("Cab Booking System"));DomainEntity entity=service.assign();service.complete(entity.id);System.out.println(entity.name+" -> "+entity.status);}}
