...
## Scope
Interview-ready low-level design for **Tic Tac Toe**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
