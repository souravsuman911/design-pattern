...
Implementation: `SnakeAndLadderClient.java`

## Category
Game and Board Simulation Systems

## Scope
Interview-ready low-level design for **Snake And Ladder**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
