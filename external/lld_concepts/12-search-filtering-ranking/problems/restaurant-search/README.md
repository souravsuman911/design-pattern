# Restaurant Search LLD

Implementation: `RestaurantSearchClient.java`

## Category
Search Filtering and Ranking

## Scope
Interview-ready low-level design for **Restaurant Search**. The code is compact but includes entities, statuses, services, storage, concurrency protection, and one executable happy path.
